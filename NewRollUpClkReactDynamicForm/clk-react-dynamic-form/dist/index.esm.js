import { FormControl as FormControl$2, InputLabel as InputLabel$2, Select as Select$2, MenuItem, Typography, FormHelperText as FormHelperText$2, OutlinedInput as OutlinedInput$2, Checkbox, ListItemText, FormLabel as FormLabel$2, RadioGroup, FormControlLabel, Radio, Alert, Stack, Button, Box, TextField as TextField$2 } from '@mui/material';
...
const _excluded$8 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"];
...
const _excluded$7 = ["className", "component", "elevation", "square", "variant"];
...
var DynamicFormElementType;
(function (DynamicFormElementType) {
    // https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/text
    DynamicFormElementType["SELECT"] = "select";
    DynamicFormElementType["MULTI_SELECT"] = "multi-select";
 ...
 */
var extractFunctionParts = function (fnString) {
    // match everything between parentheses for parameters
    // and everything between => and the end of string for the body
    var functionRegex = /^\s*\((.*?)\)\s*=>\s*({[\s\S]*}|\S.*?$)/;
    var match = fnString.trim().match(functionRegex);
    if (!match)
        return null;
    var params = match[1], body = match[2];
    // if the body is a single expression (no curly braces), wrap it with return
    var processedBody = body.trim().startsWith('{')
        ? body.trim()
        : "{ return ".concat(body.trim(), "; }");
    return { params: params, body: processedBody };
};
/**
 ...
 */
var createFunctionFromString = function (fnString) {
    var parts = extractFunctionParts(fnString);
    if (!parts)
        return null;
    try {
 ...
 */
var parseValidationRules = function (jsonRules) {
    return jsonRules.map(function (rule) {
        ...
        Object.keys(rule).forEach(function (key) {
            ...
            if (typeof value === 'string' && value.includes('=>')) {
                var fn = createFunctionFromString(value);
                if (fn) {
                    newRule[key] = fn;
                }
            }
 ...
 */
var getValidateObject = function (e) {
    var _a, _b, _c;
    ...
    // }
    var result = {};
    if (((_a = e.validationRules) === null || _a === void 0 ? void 0 : _a.validate) && Array.isArray((_b = e.validationRules) === null || _b === void 0 ? void 0 : _b.validate)) {
        var validationRules = parseValidationRules((_c = e.validationRules) === null || _c === void 0 ? void 0 : _c.validate);
        // console.log(`key: ${e.key}, validation array: ${JSON.stringify(e.validationRules?.validate)}`);
        validationRules.forEach(function (v) {
            var keys = Object.keys(v);
            var validationFunctionKey = keys[0];
            var validationFunction = v[keys[0]];
            var errorMessageValue = v[keys[1]];
 ...
 */
var getValidateErrorMessages = function (e, i18nFn) {
    var _a, _b;
    var result = {};
    if (Array.isArray((_a = e.validationRules) === null || _a === void 0 ? void 0 : _a.validate)) {
        (_b = e.validationRules) === null || _b === void 0 ? void 0 : _b.validate.forEach(function (v) {
            var keys = Object.keys(v);
            var validationFunctionKey = keys[0];
            var errorMessageValue = v[keys[1]];
 ...
 * @returns
 */
var generateElementErrorMessage = function (e, errors, i18nFn) {
    var _a, _b, _c, _d;
    var validateErrorMessages = getValidateErrorMessages(e, i18nFn);
    var errorType = (_a = errors[e.key]) === null || _a === void 0 ? void 0 : _a.type;
    var errorMessage;
    // non validate errorMessages
    if (((_b = errors[e.key]) === null || _b === void 0 ? void 0 : _b.message) && typeof ((_c = errors[e.key]) === null || _c === void 0 ? void 0 : _c.message) === 'string') {
        // errorMessage = getI18nValue(i18nFn, errors[e.key]?.message);
        errorMessage = getI18nValue(i18nFn, (_d = errors[e.key]) === null || _d === void 0 ? void 0 : _d.message);
    }
    // validate errorMessages: override default unknown error from rhf 
    if (errorType && validateErrorMessages[errorType]) {
        errorMessage = validateErrorMessages[errorType];
    }
    return errorMessage;
};
...
var parseAttributeString = function (attributeString) {
    ...
    attributeString.split(' ').forEach(function (attr) {
        if (attr.includes('=')) {
...
var getNumberValidation = function (validationRuleNumberProp) {
    var result;
...
// get shared validation form properties min, max, minLength, maxLength
var getPatternValidation = function (e) {
    var _a, _b, _c, _d;
    // get patternValidation
    var patternValidation;
    if (typeof ((_a = e.validationRules) === null || _a === void 0 ? void 0 : _a.pattern) === 'string') {
        patternValidation = new RegExp((_b = e.validationRules) === null || _b === void 0 ? void 0 : _b.pattern, 'g');
    }
    if (typeof ((_c = e.validationRules) === null || _c === void 0 ? void 0 : _c.pattern) === 'object' && ((_d = e.validationRules) === null || _d === void 0 ? void 0 : _d.pattern.value)) {
        patternValidation = { value: new RegExp(e.validationRules.pattern.value, 'g'), message: e.validationRules.pattern.message };
    }
    return patternValidation;
};
var getI18nValue = function (i18nFn, value, defaultValue) {
...
var generateInputText = function (dynamicForm, e, register, errors, i18nFn) {
    ...
    return (React__default.createElement("div", { className: 'form-element' },
        React__default.createElement(FormControl$2
        // inject dynamicAttributesFormControl
        , __assign({}, dynamicAttributesFormControl),
            React__default.createElement(TextField$1, __assign({ id: e.key, type: e.type, label: i18n['label'], placeholder: i18n['placeHolder'], defaultValue: i18n['defaultValue'], helperText: errorMessage || i18n['helperText'], error: errors[e.key] !== undefined }, register(e.key, {
                ...
                minLength: ((_f = e.validationRules) === null || _f === void 0 ? void 0 : _f.minLength) ? getNumberValidation((_g = e.validationRules) === null || _g === void 0 ? void 0 : _g.minLength) : undefined,
...
var generateInputSelect = function (dynamicForm, e, register, errors, watch, i18nFn) {
    ...
    return (React__default.createElement("div", { className: 'form-element' },
        ...
        // inject dynamicAttributesFormControl
        , __assign({}, dynamicAttributesFormControl),
            React__default.createElement(InputLabel$2, null, e.label),
            React__default.createElement(Select$2, __assign({ id: e.key, type: e.type, label: i18n['label'], placeholder: i18n['placeHolder'], defaultValue: i18n['defaultValue'], helperText: errorMessage || i18n['helperText'] }, register(e.key, {
                required: (_a = e.validationRules) === null || _a === void 0 ? void 0 : _a.required,
                min: ((_b = e.validationRules) === null || _b === void 0 ? void 0 : _b.min) ? getNumberValidation((_c = e.validationRules) === null || _c === void 0 ? void 0 : _c.min) : undefined,
                max: ((_d = e.validationRules) === null || _d === void 0 ? void 0 : _d.max) ? getNumberValidation((_e = e.validationRules) === null || _e === void 0 ? void 0 : _e.max) : undefined,
                minLength: ((_f = e.validationRules) === null || _f === void 0 ? void 0 : _f.minLength) ? getNumberValidation((_g = e.validationRules) === null || _g === void 0 ? void 0 : _g.minLength) : undefined,
                ...
                return React__default.createElement(MenuItem, { key: value, value: value }, label);
            }))),
            errorMessage ? React__default.createElement(Typography, { variant: "caption", color: "error" }, errorMessage) : React__default.createElement(FormHelperText$2, null, e.helperText))));
};
var generateInputMultiSelect = function (dynamicForm, e, register, errors, watch, setValue, i18nFn) {
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(FormControl$2, __assign({ sx: { mb: 1 /*, width: 300*/ } }, dynamicAttributesFormControl),
            React__default.createElement(InputLabel$2, null, e.label),
            React__default.createElement(Select$2, __assign({ fullWidth: true, multiple: true, id: e.key, type: e.type, label: i18n['label'], placeholder: i18n['placeHolder'], 
                ...
                // required for reset form works
                value: currentValue, onChange: function (event) {
                    var newValue = typeof event.target.value === 'string'
                        ? event.target.value.split(',')
                        : event.target.value;
                    setValue(e.key, newValue);
                }, input: React__default.createElement(OutlinedInput$2, { label: "Tag" }), renderValue: function (selected) { return (typeof selected === 'string' ? selected.split(',').join(', ') : selected.join(', ')); }, MenuProps: MenuProps, 
                // inject styles
                sx: (_d = (_c = dynamicForm === null || dynamicForm === void 0 ? void 0 : dynamicForm.properties) === null || _c === void 0 ? void 0 : _c.styles) === null || _d === void 0 ? void 0 : _d.multiSelect }), Array.isArray(e.options) && ((_e = e.options) === null || _e === void 0 ? void 0 : _e.map(function (name) { return (React__default.createElement(MenuItem, { key: name, value: name.split(':')[0] },
                React__default.createElement(Checkbox, { checked: currentValue.includes(name.split(':')[0]) }),
                React__default.createElement(ListItemText, { primary: name.split(':')[1] }))); }))),
            errorMessage ? React__default.createElement(Typography, { variant: "caption", color: "error" }, errorMessage) : React__default.createElement(FormHelperText$2, null, e.helperText))));
};
var generateInputRadio = function (dynamicForm, e, errors, control, i18nFn) {
    ...
    return (React__default.createElement("div", { className: 'form-element' },
        ...
        // inject dynamicAttributesFormControl
        , __assign({}, dynamicAttributesFormControl),
            React__default.createElement(FormLabel$2, null, e.label),
            React__default.createElement(Controller, __assign({ name: e.key, defaultValue: i18n['defaultValue'] }, dynamicAttributes, { control: control, render: function (_a) {
                    var _b;
                    var field = _a.field; _a.fieldState; _a.formState;
                    return (React__default.createElement(RadioGroup, __assign({}, field), Array.isArray(e.options) && ((_b = e.options) === null || _b === void 0 ? void 0 : _b.map(function (e) {
                        var label = e;
                        var value = e;
                        // override defaults
                        if (e.includes(':')) {
                        ...
                        return React__default.createElement(FormControlLabel, { key: value, label: label, value: value, control: React__default.createElement(Radio, null) });
                    }))));
                }, 
                // inject styles
...
var generateInputCheckBox = function (dynamicForm, e, register, watch, i18nFn) {
    ...
    return (React__default.createElement("div", { className: 'form-element' },
        React__default.createElement(FormControl$2, __assign({}, dynamicAttributesFormControl),
            React__default.createElement(FormControlLabel, { control: React__default.createElement(Checkbox, __assign({ id: e.key, checked: (_a = currentValue !== null && currentValue !== void 0 ? currentValue : e.defaultValue) !== null && _a !== void 0 ? _a : false, onChange: function (event) {
            ...
            e.helperText && React__default.createElement(FormHelperText$2, null, i18n['helperText']))));
};
...
var DynamicFormComponent = function (_a) {
    ...
    var _2 = useForm(), control = _2.control, register = _2.register, handleSubmit = _2.handleSubmit, reset = _2.reset, watch = _2.watch, setValue = _2.setValue, errors = _2.formState.errors;
    // watcher
    var watcher = useRef({});
    // state for field-specific and global errors
    var _3 = useState({}), globalErrors = _3[0], setGlobalErrors = _3[1];
    var _4 = useState(null), globalError = _4[0], setGlobalError = _4[1];
    // inner function
    function renderFormElements(dynamicForm) {
        return dynamicForm.elements.map(function (e) {
            ...
            if (e.visible) {
                var isVisible = createFunctionFromString(e.visible);
                if (isVisible) {
                    showElement = isVisible(watcher.current);
                }
                // console.log(`isVisible: ${isVisible}`);
            }
            return showElement && (React__default.createElement("div", { key: e.key }, generateElement(dynamicForm, e, register, errors, control, watch, setValue, i18nFn)));
        });
    }
    // OPT #1
    ...
    var validateForm = function (data) {
        ...
        var newErrors = {};
        // postValidate
        if (((_a = tool.form) === null || _a === void 0 ? void 0 : _a.actions['submit']) && ((_b = tool.form) === null || _b === void 0 ? void 0 : _b.actions['submit']['validateForm'])) {
            var postValidate_1 = createFunctionFromString((_c = tool.form) === null || _c === void 0 ? void 0 : _c.actions['submit']['validateForm']);
            if (postValidate_1) {
                // this will internally throw error
                postValidate_1(data, newErrors, setGlobalErrors);
            }
        }
    ...
    var postValidate = function (data) {
        var _a, _b, _c;
        try {
            // postValidate
            if (((_a = tool.form) === null || _a === void 0 ? void 0 : _a.actions['submit']) && ((_b = tool.form) === null || _b === void 0 ? void 0 : _b.actions['submit']['postValidate'])) {
                var validateForm_1 = createFunctionFromString((_c = tool.form) === null || _c === void 0 ? void 0 : _c.actions['submit']['postValidate']);
                if (validateForm_1) {
                    // this will internally throw error
                    validateForm_1(data);
                }
    ...
    // OPT #2
    var onSubmit = function (data, e, tool) {
        var _a, _b, _c;
        ...
        var isValidForm = validateForm(data);
        if (!isValidForm) {
            return;
        }
        // perform post-validation
        try {
            var postValidationResult = postValidate(data);
            ...
            // getPayload
            if (((_a = tool.form) === null || _a === void 0 ? void 0 : _a.actions['submit']) && ((_b = tool.form) === null || _b === void 0 ? void 0 : _b.actions['submit']['getPayload'])) {
                // console.log(`tool.form?.actions['submit']['getPayload']: [${tool.form?.actions['submit']['getPayload']}]`);
                var getPayload = createFunctionFromString((_c = tool.form) === null || _c === void 0 ? void 0 : _c.actions['submit']['getPayload']);
                if (getPayload) {
    ...
    return (React__default.createElement(FormControl$2, { fullWidth: true, sx: { height: (_c = (_b = tool === null || tool === void 0 ? void 0 : tool.form) === null || _b === void 0 ? void 0 : _b.properties) === null || _c === void 0 ? void 0 : _c.height } },
        React__default.createElement("form", { 
            ...
            globalErrors && Object.keys(globalErrors).length > 0 && (React__default.createElement(Alert, { severity: "error", icon: false, style: { marginTop: 10, padding: 0 } },
                React__default.createElement("ul", { style: { margin: 0, paddingLeft: '1.75em' } }, Object.keys(globalErrors).map(function (e) { return React__default.createElement("li", { key: e }, globalErrors[e]); })))),
            globalError && (React__default.createElement(Alert, { severity: "error", icon: false, style: { marginTop: 10, padding: 0 } },
                React__default.createElement("ul", { style: { margin: 0, paddingLeft: '1.75em' } },
                    React__default.createElement("li", null, globalError)))),
            ((_e = (_d = tool === null || tool === void 0 ? void 0 : tool.form) === null || _d === void 0 ? void 0 : _d.properties) === null || _e === void 0 ? void 0 : _e.helperText) && React__default.createElement(FormHelperText$2, { style: { marginTop: 10, marginLeft: 0, marginRight: 0 } }, tool.form.properties.helperText),
            React__default.createElement(Stack, { direction: "row", justifyContent: "flex-end", alignItems: "center", spacing: 2, sx: { marginTop: 2 } },
                onCloseHandle &&
                    React__default.createElement(Button, { variant: 'contained', type: "submit", sx: (_h = (_g = (_f = tool === null || tool === void 0 ? void 0 : tool.form) === null || _f === void 0 ? void 0 : _f.properties) === null || _g === void 0 ? void 0 : _g.styles) === null || _h === void 0 ? void 0 : _h.button, onClick: function (e) {
                            e.preventDefault();
                            onCloseHandle();
                ...
                React__default.createElement(Button, { variant: 'contained', type: "reset", sx: (_q = (_p = (_o = tool === null || tool === void 0 ? void 0 : tool.form) === null || _o === void 0 ? void 0 : _o.properties) === null || _p === void 0 ? void 0 : _p.styles) === null || _q === void 0 ? void 0 : _q.button, 
...
var MyForm = function () {
    ...
    return (React__default.createElement(Box, { component: "form", onSubmit: handleSubmit(onSubmit), sx: { maxWidth: 400 } },
        React__default.createElement(TextField$2, __assign({ fullWidth: true, margin: "normal", label: "First Name" }, register("firstName", { required: "First name is required" }), { error: !!errors.firstName, helperText: (_a = errors.firstName) === null || _a === void 0 ? void 0 : _a.message })),
        React__default.createElement(TextField$2, __assign({ fullWidth: true, margin: "normal", label: "Last Name" }, register("lastName", { required: "Last name is required" }), { error: !!errors.lastName, helperText: (_b = errors.lastName) === null || _b === void 0 ? void 0 : _b.message })),
        React__default.createElement(TextField$2, __assign({ fullWidth: true, margin: "normal", label: "Email" }, register("email", {
        ...
        React__default.createElement(Button, { type: "submit", variant: "contained", sx: { mt: 2 } }, "Submit")));
};

export { DynamicFormComponent, MyForm };
