    ...
    return (React__default.createElement("div", null,
        React__default.createElement(FormControl$2, __assign({ sx: { mb: 1 /*, width: 300*/ } }, dynamicAttributesFormControl),
            ...
            React__default.createElement(Select$2, __assign({ fullWidth: true, multiple: true, id: e.key, type: e.type, label: i18n['label'], placeholder: i18n['placeHolder'], 
                ...
                var _a = getOptionsValueAndLabel(i18nFn, option), value = _a[0], label = _a[1];
                return (React__default.createElement(MenuItem, { key: option, value: value },
                    React__default.createElement(Checkbox, { checked: currentValue.includes(value) }),
                    React__default.createElement(ListItemText, { primary: label })));
            }))),
            errorMessage ? React__default.createElement(Typography, { variant: "caption", color: "error" }, errorMessage) : React__default.createElement(FormHelperText$2, null, i18n['helperText']))));
};
    ...
    return (React__default.createElement("div", { className: 'form-element' },
        ...
        , __assign({}, dynamicAttributesFormControl),
            ...
            React__default.createElement(Controller, __assign({ name: e.key, defaultValue: i18n['defaultValue'] }, dynamicAttributes, { control: control, render: function (_a) {
                    ...
                    return (React__default.createElement(RadioGroup, __assign({}, field), Array.isArray(e.options) && ((_b = e.options) === null || _b === void 0 ? void 0 : _b.map(function (option) {
                        var _a = getOptionsValueAndLabel(i18nFn, option), value = _a[0], label = _a[1];
