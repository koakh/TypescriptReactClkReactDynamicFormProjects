...
import { DynamicForm, DynamicFormElement } from '../interfaces';
import { createFunctionFromString } from '../main';
...
const DynamicFormComponent: React.FC<Props> = ({ tool, i18nFn }: Props) => {
  const {
    control,
    register,
    handleSubmit,
  ...
  return (
    <FormControl fullWidth>
      ...
      >
        ...
        {/* TODO: reset field values & errors */}
        <button
          className='form-button'
          style={{ display: 'block', marginTop: 10 }}
          type="reset"
